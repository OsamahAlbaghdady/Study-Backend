...
namespace BackEndStructuer.Repository
{
    public class RepositoryWrapper : IRepositoryWrapper
    {
        ...
        private IMedicalFieldRepository _MedicalField;
        
        public IMedicalFieldRepository MedicalField
        {
            get
            {
                if (_MedicalField == null)
                {
                    _MedicalField = new MedicalFieldRepository(_context, _mapper);
                }

                return _MedicalField;
            }
        }
    }
}