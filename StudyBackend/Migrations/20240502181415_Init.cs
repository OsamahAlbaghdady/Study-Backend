    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DegreeFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DegreeFields_Degrees_DegreeId",
                        column: x => x.DegreeId,
                        principalTable: "Degrees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DegreeFields_Fields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "Fields",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DegreeFields_Universities_UniversityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UniversityDegrees_Degrees_DegreeId",
                        column: x => x.DegreeId,
                        principalTable: "Degrees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UniversityDegrees_Universities_UniversityId",
                        column: x => x.UniversityId,
                        principalTable: "Universities",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DegreeFields_DegreeId",
                table: "DegreeFields",
                column: "DegreeId");

            migrationBuilder.CreateIndex(
                name: "IX_DegreeFields_FieldId",
                table: "DegreeFields",
                column: "FieldId");

            migrationBuilder.CreateIndex(
                name: "IX_DegreeFields_UniversityId",
                table: "DegreeFields",
                column: "UniversityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UniversityDegrees_DegreeId",
                table: "UniversityDegrees",
                column: "DegreeId");

            migrationBuilder.CreateIndex(
                name: "IX_UniversityDegrees_UniversityId",
                table: "UniversityDegrees",
                column: "UniversityId");
